/*
   ...
   Compile as 
   cl /O2 /GX /DZZNS=8 akew4.cpp zzn4.cpp zzn2.cpp ecn2.cpp big.cpp zzn.cpp 
   ecn.cpp miracl.lib
...
//
    ...
    if (!power_tate(sA,Server,q*COF,cf,Fr,a,res)) cout << "Trouble" << endl;
...
//    ap=powl(res,a);
    ...
    if (!power_tate(Alice,sS,q*COF,cf,Fr,s,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn2)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
...
//    sp=powl(res,s);
    ...
    if (!power_tate(sB,Server,q*COF,cf,Fr,b,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn2)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
...
//    bp=powl(res,b);
    ...
    if (!power_tate(Bob,sS,q*COF,cf,Fr,s,res)) cout << "Trouble" << endl;
    if (powl(res,q)!=(ZZn2)1)
    {
        cout << "Wrong group order - aborting" << endl;
        exit(0);
